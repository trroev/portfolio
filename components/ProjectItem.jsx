...
export const ProjectItem = ({ title, img, tech, projectUrl }) => {
  return (
    <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-br from-green-900 via-lime-500 to-emerald-700">
